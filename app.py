...
st.markdown("""
<style>
  /* ── Global text color fix — prevents white text on light background ── */
  html, body, [class*="css"], [data-testid="stAppViewContainer"],
  [data-testid="stSidebar"], .main, p, span, div, label, h1, h2, h3, h4 {
    color: #111827 !important;
  }
  /* Restore explicit colored elements */
  ...
  /* Agent roster row */
  .agent-row { color: #111827 !important; display: flex; align-items: center; gap: 10px; padding: 10px 12px;
  ...
  .status-row { color: #111827 !important; display: flex; align-items: center; padding: 14px 16px;
  ...
  .metric-num  { font-size: 36px; font-weight: 700; color: #111827; }
